...
namespace Cosmicrafts.MainCanister.Models
{
	public class StationMetadata
	{
		...
		public StationMetadata(OptionalValue<BasicMetadata> basic, GeneralMetadata general, OptionalValue<SkillMetadata> skills, OptionalValue<SkinMetadata> skins, OptionalValue<SoulMetadata> soul)
		{
			this.Basic = basic;
