...
namespace Cosmicrafts.MainCanister.Models
{
	public class AchievementLine
	{
		...
		public AchievementLine(UnboundedUInt categoryId, bool claimed, bool completed, UnboundedUInt id, List<IndividualAchievement> individualAchievements, string name, UnboundedUInt progress, UnboundedUInt requiredProgress, List<AchievementReward> reward)
		{
