...
namespace Cosmicrafts.backend.Models
{
	public class MissionsUser
	{
		...
		public MissionsUser(ulong expiration, ulong finishDate, bool finished, UnboundedUInt idMission, MissionCategory missionCategory, MissionType missionType, UnboundedUInt progress, UnboundedUInt rewardAmount, MissionRewardType rewardType, ulong startDate, UnboundedUInt total)
		{
