...
namespace Cosmicrafts.MainCanister.Models
{
	public class IndividualAchievement
	{
		...
		public IndividualAchievement(UnboundedUInt achievementId, AchievementType achievementType, bool claimed, bool completed, UnboundedUInt id, string name, UnboundedUInt progress, UnboundedUInt requiredProgress, List<AchievementReward> reward)
		{
