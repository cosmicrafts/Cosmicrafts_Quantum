...
namespace Cosmicrafts.MainCanister.Models
{
	public class SpaceshipMetadata
	{
		...
		public SpaceshipMetadata(OptionalValue<BasicMetadata> basic, GeneralMetadata general, OptionalValue<SkillMetadata> skills, OptionalValue<SkinMetadata> skins, OptionalValue<SoulMetadata> soul)
		{
			this.Basic = basic;
