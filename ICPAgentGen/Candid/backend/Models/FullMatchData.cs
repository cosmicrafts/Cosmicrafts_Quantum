...
namespace Cosmicrafts.backend.Models
{
	public class FullMatchData
	{
		...
		public class Player1Info
		{
			...
			public Player1Info(Avatarid1 avatar, double elo, Playerid1 id, Level1 level, bool matchAccepted, PlayerGameData playerGameData, Username1 username)
			{
				this.Avatar = avatar;
				this.Elo = elo;
				this.Id = id;
		...
		public class Player2Info : OptionalValue<FullMatchData.Player2Info.Player2InfoValue>
		{
			...
			public class Player2InfoValue
			{
				...
				public Player2InfoValue(Avatarid1 avatar, double elo, Playerid1 id, Level1 level, bool matchAccepted, PlayerGameData playerGameData, Username1 username)
				{
					this.Avatar = avatar;
					this.Elo = elo;
					this.Id = id;
