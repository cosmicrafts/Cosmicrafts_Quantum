...
using Cosmicrafts.Managers;
    ...
    public class Login : MonoBehaviour
    {
        ...
        private async Task WaitForCandidApiInitialization()
        {
            ...
            while (CandidApiManager.Instance == null || CandidApiManager.Instance.MainCanister == null)
            {
                await Task.Yield();
            }
...
private void OnDestroy()
{
    ...
    else
    {
        ...
        {
            var playerInfo = await CandidApiManager.Instance.MainCanister.GetPlayer();
    ...
    catch (Exception ex)
    {
        ...
        public async void SetPlayerName()
        {
            if (!isRegisteringPlayer && !string.IsNullOrEmpty(inputNameField.text))
            {
                ...
                var request = await CandidApiManager.Instance.MainCanister.RegisterPlayer(inputNameField.text, avatarID);
