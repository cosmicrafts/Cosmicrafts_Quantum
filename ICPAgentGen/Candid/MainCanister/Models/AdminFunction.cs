...
namespace Cosmicrafts.MainCanister.Models
{
	...
	public class AdminFunction
	{
		...
		public static AdminFunction CreateMission((string, Missioncategory1, Missiontype1, RewardType, UnboundedUInt, UnboundedUInt, ulong) info)
		{
		...
		public (string, Missioncategory1, Missiontype1, RewardType, UnboundedUInt, UnboundedUInt, ulong) AsCreateMission()
		{
			this.ValidateTag(AdminFunctionTag.CreateMission);
			return ((string, Missioncategory1, Missiontype1, RewardType, UnboundedUInt, UnboundedUInt, ulong))this.Value!;
		}
