...
namespace Cosmicrafts.MainCanister.Models
{
	public class WeaponMetadata
	{
		...
		public WeaponMetadata(OptionalValue<BasicMetadata> basic, GeneralMetadata general, OptionalValue<SkillMetadata> skills, OptionalValue<SkinMetadata> skins, OptionalValue<SoulMetadata> soul)
		{
			this.Basic = basic;
